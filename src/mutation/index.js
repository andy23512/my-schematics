...
function addProvidersAndExportStatementToNgModule(_options) {
    return (_tree, _context) => {
        ...
        const servicePath = `/${_options.path}/${core_1.strings.dasherize(_options.name)}-mutation.service`;
        const relativePath = find_module_1.buildRelativePath(modulePath, servicePath);
        const classifiedName = core_1.strings.classify(_options.name) + 'MutationService';
...
exports.genMutation = genMutation;
